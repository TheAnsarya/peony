...
reset:
	cpx #$34                 ; $8000: e0 34 Game entry point - First code executed when ROM loads
Original game jumps to initialization routine from here
	jsl $dc7a30              ; $8002: 22 30 7a dc
loc_8006:
	ora DataTiles048000,x    ; $8006: 15 64
	asl $00de,x              ; $8008: 1e de 00
	ora (PLB_Label)          ; $800b: 12 32
	ply                      ; $800d: 7a
	bit StatusIcon_ToggleTileFrame,x ; $800e: 34 21
	bpl $8001                ; $8010: 10 ef
loc_8012:
	beq $8015                ; $8012: f0 01
loc_8014:
...
loc_803f:
	...
	ora ($01),y              ; $8041: 11 01
	ror                      ; $8043: 6a
	and Input_Right          ; $8044: 25 54
	and (Animation_CheckFrameCounter) ; $8046: 32 ee
	cop #$35                 ; $8048: 02 35
	ror $3f,x                ; $804a: 76 3f
	ror                      ; $804c: 6a
	stp                      ; $804d: db
	lda $1100                ; $804e: ad 00 11
	jsl $ea4211              ; $8051: 22 11 42 ea TIMEUP
loc_8055:
	ply                      ; $8055: 7a
...
DB_Label_00806E:
	cpx #$f0                 ; $8073: e0 f0 -------------------------------------------------------------------------------
	ora (Scroll_Menu_Up,x)   ; $8075: 01 ff
	sbc ($13),y              ; $8077: f1 13
	ply                      ; $8079: 7a
	eor Sprite_UpdateDone,s  ; $807a: 43 fc
	ldx $2400,y              ; $807c: be 00 24
	eor ($1e,s),y            ; $807f: 53 1e
	inc $f26a                ; $8081: ee 6a f2
	rol $34df,x              ; $8084: 3e df 34
	and (StatusIcon_ToggleTileFrame),y ; $8087: 31 21
	and $40,x                ; $8089: 35 40
	ror                      ; $808b: 6a
	cop #$1e                 ; $808c: 02 1e
	sbc $52,s                ; $808e: e3 52
	...
	ora DataTiles048000      ; $809b: 05 64
	ply                      ; $809d: 7a
	and (Animation_FrameNotReady),y ; $809e: 31 fe

...
; === Code Block $f000-$f000 ===
.org $f000

reset:
	jmp $f2ef                ; $f000: 4c ef f2

; === Code Block $f008-$f05c ===
.org $f008
...
; === Code Block $f2b1-$f2b1 ===
.org $f2b1

loc_f2b1:
	rts                      ; $f2b1: 60

; === Code Block $f2b2-$f2d2 ===
.org $f2b2
...
; === Code Block $f590-$f590 ===
.org $f590

loc_f590:
	jmp $f5d3                ; $f590: 4c d3 f5

; === Code Block $f593-$f5d3 ===
.org $f593
...
; === Code Block $f6d4-$f6d4 ===
.org $f6d4

loc_f6d4:
	rts                      ; $f6d4: 60

; === Code Block $f6d5-$f6e8 ===
.org $f6d5
...
; === Code Block $f89e-$f89e ===
.org $f89e

loc_f89e:
	rts                      ; $f89e: 60

; === Code Block $f8a5-$f8c0 ===
.org $f8a5
...
; === Code Block $f97c-$f97c ===
.org $f97c

loc_f97c:
	jmp $f988                ; $f97c: 4c 88 f9

; === Code Block $f97f-$f988 ===
.org $f97f
...
; === Code Block $f9a6-$f9a6 ===
.org $f9a6

loc_f9a6:
	rts                      ; $f9a6: 60

; === Code Block $f9b3-$f9d9 ===
.org $f9b3
...
; === Code Block $fa22-$fa22 ===
.org $fa22

loc_fa22:
	rts                      ; $fa22: 60

; === Code Block $fa23-$fa2b ===
.org $fa23

...
; --- Block at $8000-$8000 ---
bank_func_table:
	brk                     ; 8000: 00           Function pointer table for current bank
...
; --- Block at $8000-$8013 ---
bank_func_table:
	bit $af                 ; 8000: 24 af        Function pointer table for current bank
	cpy $ab                 ; 8002: c4 ab       
	sei                     ; 8004: 78          
	sta ($5e,x)             ; 8005: 81 5e       
	sta ($a0,x)             ; 8007: 81 a0       
...
; --- Block at $8000-$8061 ---
bank_func_table:
	bcs $7fbe               ; 8000: b0 bc        Function pointer table for current bank
loc_8002:
	plp                     ; 8002: 28          
	*nop #$86               ; 8003: 80 86       
	*nop #$19               ; 8005: 82 19       
...
clear_sprites_loop:
	ldx #$00                ; c6be: a2 00       
	lda #$f0                ; c6c0: a9 f0       
	sta oam_buffer,x        ; c6c2: 9d 00 02    
	inx                     ; c6c5: e8          
	bne $c6c2               ; c6c6: d0 fa       
loc_c6c8:
	rts                     ; c6c8: 60          
...
clear_state_loop:
	lda #$00                ; c9ba: a9 00       
	tax                     ; c9bc: aa          
	sta game_state          ; c9bd: 8d 0a 60    
	sta game_flags          ; c9c0: 8d 2f 60    
	sta player_stats,x      ; c9c3: 9d 1c 60    
	inx                     ; c9c6: e8          
	cpx #$10                ; c9c7: e0 10       
	bcc $c9c3               ; c9c9: 90 f8       
loc_c9cb:
...
bank_call_wrapper:
	sta $37                 ; fcbd: 85 37       
	stx $38                 ; fcbf: 86 38       
	lda current_bank        ; fcc1: ad 04 60    
	pha                     ; fcc4: 48          
	php                     ; fcc5: 08          
	lda current_bank        ; fcc6: ad 04 60    
	sta previous_bank       ; fcc9: 8d 06 60    
...
bank_call_execute:
	...
	lda $37                 ; fcd5: a5 37       
	plp                     ; fcd7: 28          
	jsr jump_addr_lo        ; fcd8: 20 30 00    
bank_call_return:
	php                     ; fcdb: 08          
	sta $37                 ; fcdc: 85 37       
	pla                     ; fcde: 68          
...
lookup_function_ptr:
	...
	asl                     ; fcf3: 0a          
	tax                     ; fcf4: aa          
	lda bank_func_table,x   ; fcf5: bd 00 80    
	sta $31                 ; fcf8: 85 31       
...
bank_switch_handler:
	sta $37                 ; fd00: 85 37       
	stx $38                 ; fd02: 86 38       
	lda current_bank        ; fd04: ad 04 60    
	pha                     ; fd07: 48          
...
loc_fdbe:
	sta current_bank        ; fdbe: 8d 04 60    
	lda #$1e                ; fdc1: a9 1e       
	sta player_name         ; fdc3: 8d 01 60    
	lda #$00                ; fdc6: a9 00       
...
loc_fef0:
	lda current_bank        ; fef0: ad 04 60    
...
; --- Block at $ff91-$ff96 ---
set_bank:
	sta current_bank        ; ff91: 8d 04 60    
	nop                     ; ff94: ea          
	nop                     ; ff95: ea          

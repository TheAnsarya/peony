...
; === Code Block $c6bb-$c6c8 ===
.org $c6bb

loc_c6bb:
	jsr $ff74                ; $c6bb: 20 74 ff
loc_c6be:
	ldx #$00                 ; $c6be: a2 00
	lda #$f0                 ; $c6c0: a9 f0
...
; === Code Block $c9b5-$c9cb ===
.org $c9b5

loc_c9b5:
	lda #$00                 ; $c9b5: a9 00
	jsr $ff91                ; $c9b7: 20 91 ff
loc_c9ba:
	lda #$00                 ; $c9ba: a9 00
	tax                      ; $c9bc: aa
...
; === Code Block $fc80-$fc87 ===
.org $fc80

loc_fc80:
	pha                      ; $fc80: 48
	lda #$03                 ; $fc81: a9 03
	jsr $ff96                ; $fc83: 20 96 ff
loc_fc86:
	pla                      ; $fc86: 68
	rts                      ; $fc87: 60

; === Code Block $fcbd-$fceb ===
.org $fcbd
...
; === Code Block $fcec-$fcff ===
.org $fcec

loc_fcec:
	lda $30                  ; $fcec: a5 30
	jsr $ff91                ; $fcee: 20 91 ff
loc_fcf1:
	lda $31                  ; $fcf1: a5 31
	asl                      ; $fcf3: 0a
	tax                      ; $fcf4: aa
...
loc_fd00:
	...
	pha                      ; $fd07: 48
	jsr $fcec                ; $fd08: 20 ec fc
loc_fd0b:
	pla                      ; $fd0b: 68
	jsr $ff91                ; $fd0c: 20 91 ff
loc_fd0f:
	ldx $38                  ; $fd0f: a6 38
	lda $31                  ; $fd11: a5 31
	sta $00,x                ; $fd13: 95 00
...
loc_fde6:
	...
	jsr $c6bb                ; $fdeb: 20 bb c6
loc_fdee:
	jsr $ff74                ; $fdee: 20 74 ff
loc_fdf1:
	jmp $c9b5                ; $fdf1: 4c b5 c9

; === Code Block $fdf4-$fe06 ===
.org $fdf4

loc_fdf4:
	inc $ffdf                ; $fdf4: ee df ff
	lda $6001                ; $fdf7: ad 01 60
	jsr $fe09                ; $fdfa: 20 09 fe
loc_fdfd:
	lda $6002                ; $fdfd: ad 02 60
	jsr $ffac                ; $fe00: 20 ac ff
loc_fe03:
	lda $6003                ; $fe03: ad 03 60
	jmp $ffc2                ; $fe06: 4c c2 ff

; === Code Block $fe09-$fe1f ===
.org $fe09
...
; === Code Block $fe55-$fe5d ===
.org $fe55

loc_fe55:
	jsr $ff2d                ; $fe55: 20 2d ff
loc_fe58:
	lda #$02                 ; $fe58: a9 02
	sta $4014                ; $fe5a: 8d 14 40 OAMDMA
	jmp $fee0                ; $fe5d: 4c e0 fe

; === Code Block $fe60-$fe67 ===
.org $fe60
...
loc_fed3:
	...
	jsr $fdf4                ; $fee0: 20 f4 fd
loc_fee3:
	lda $6005                ; $fee3: ad 05 60
	bne $fef0                ; $fee6: d0 08
loc_fee8:
	lda #$01                 ; $fee8: a9 01
	jsr $ff96                ; $feea: 20 96 ff
loc_feed:
	jsr $8028                ; $feed: 20 28 80
loc_fef0:
	lda $6004                ; $fef0: ad 04 60
	jsr $ff91                ; $fef3: 20 91 ff
loc_fef6:
	tsx                      ; $fef6: ba
...
loc_ff25:
	...
	tax                      ; $ff28: aa
	pla                      ; $ff29: 68
	jmp $fd3a                ; $ff2a: 4c 3a fd

; === Code Block $ff2d-$ff53 ===
.org $ff2d
